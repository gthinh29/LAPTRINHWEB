// file: admin_editor.js (Phiên bản cuối cùng - Sửa lỗi gửi nội dung rỗng)
document.addEventListener('DOMContentLoaded', () => {
    ...
    // === LOGIC QUAN TRỌNG NHẤT: XỬ LÝ KHI SUBMIT FORM ===
    // Đảm bảo sao chép nội dung từ editor vào textarea ẩn trước khi gửi đi.
    if (form) {
    ...
    // Đồng bộ nội dung ban đầu cho trang sửa bài viết
